...
It was desired to leverage previous work by others, and available resources
...
\begin{figure*}
	\begin{center}		
		\begin{tikzpicture}[scale=0.7]
		\node (fig1) at (0,0)
		{\includegraphics[width=1\textwidth]{tba_geometry}};
...
\begin{figure}
	\begin{center}		
		\begin{tikzpicture}[scale=0.7]
		\node (fig1) at (0,0)
		{\includegraphics[width=0.48\textwidth]{scatter_kicker_entrance}%
			\includegraphics[width=0.48\textwidth]{scatter_kicker_exit}};
...
\begin{figure*}
	\begin{center}		
		\begin{tikzpicture}[scale=0.7]
		\node (fig1) at (0,0)
		{\includegraphics[width=1\textwidth]{kicker}};
...
\begin{figure}%[h]
	\begin{center}
		\includegraphics[width=\textwidth]{kicker1}
...
\begin{figure*}
	\begin{center}		
		\begin{tikzpicture}[scale=0.7]
		\node (fig1) at (0,0)
		{\includegraphics[width=0.5\textwidth]{kicker_yag}};
